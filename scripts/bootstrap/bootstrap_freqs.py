...
import bootstrap
from ..control.recalculate_freqs import *
...
try:
    ...
    print("Usage: python recalculate_freqs.py POP_SIZE,SAMPLE_SIZE,NUM_OBS_ALLELES CLIMB_FILE CONTROL_FILE FREQ_FILE "
          "OUTPUT_FILE BOOTSTRAP_ITER")
    print()
    raise

print([str(x.strip()) for x in freq_params.split(',')])
